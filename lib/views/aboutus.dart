            ...
            child: Column(
              ...
              children: <Widget>[
                const ListTile(
                  ...
                  subtitle: Text(
                      'This community healthcare management app (Abhinav_21MCA3014,HMS hospital management app) built in Flutter Firebase App for iOS, Android, Web & Desktop. Complete Healthcare Hospital Management (Patient, OPD, IPD, Rx, Lab) in Flutter Firebase App for iOS, Android, Web & Desktop.\n\nThis project is a community version and is absolutely free for private use.'),
                ),
                const ListTile(
                  leading: Icon(
                    Icons.album,
                ...
                Column(
                  ...
                  children: <Widget>[
                    IconButton(
                      ...
                      onPressed: () => setState(() {
                        _launched = _launchInBrowser(
                            'https://www.linkedin.com/in/abhinav-pandey-828b62226');
                      }),
                    ),
                    Text(
                      "Contact Tracing App",
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    IconButton(
                      icon: SvgPicture.network(
                        'https://github.com/Abhinav9211',
                        width: 40,
                        height: 40,
                      ),
                      onPressed: () => setState(() {
                        _launched = _launchInBrowser(
                            'https://www.instagram.com/a_b_h_i_n_a_v_9211/');
                      }),
                    ),
                    const SizedBox(width: 8),
                    IconButton(
                    ...
                    IconButton(
                      ...
                      onPressed: () => setState(() {
                        _launched = _launchInBrowser(
                            'https://www.linkedin.com/in/abhinav-pandey-828b62226a');
                      }),
                    ),
                  ],
                ),
